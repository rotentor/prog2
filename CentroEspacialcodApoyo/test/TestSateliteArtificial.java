...
public class TestSateliteArtificial {
	...
	/** La constante del factor del �ndice de color. */
	private static final double FACTOR_INDICE = 2.1;
	/** La constante para el l�mite del campo magn�tico. */
	private static final double LIMITE = 1000.0;
	/** El sat�lite que se utiliza en los tests. */
	...
	// -------------------------------------------------------------------
	/** Prueba si hay alerta de tormenta magn�tica */
	@Test
	public void testHayAlertaTormentaMagnetica1() {
		assertEquals("\nDetecci�n de alerta magn�tica incorrecta:\n",
